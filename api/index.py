...
def _pa_wsgi_path() -> str:
    ...
    # username's actual case. Lowercasing every candidate keeps auto-deploy's
    # reload touch pointed at the file PA actually loads (a mixed-case
    # username would otherwise touch a nonexistent path and silently skip
    # the reload).
    for user in users:
