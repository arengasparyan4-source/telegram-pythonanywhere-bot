...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "btn_video": {"hy": "🎥 Վիդեո", "ru": "🎥 Видео", "en": "🎥 Video"},
    "btn_homework": {
...
_HELP_LINES: dict[str, list[str]] = {
    "hy": [
        ...
        "/word — բառարան՝ բացատրիր դժվար բառը 📖",
        ...
        "/joke — կատակ ու հետաքրքիր փաստ 😄 (/stopjoke՝ անջատելու)",
        ...
        "/review — կրկնության ժամանակն է հասած թեմաներ 🧠",
        "/summary — այս սեսիայի կարճ ամփոփում 📌",
        "/askclass — ուսուցչի հարց դասարանին (խմբում) 👥",
        "/answers — տեսնել դասարանի պատասխանները (ուսուցիչ) 📥",
        "/leaderboard — առաջատարների աղյուսակ 🏆",
        "/duel — մենամարտ ընկերոջ հետ 🤝 (/join՝ միանալու համար)",
        ...
        "🎨 ուղարկիր թեմայիդ նկարը՝ ես կուրախանամ 🙂",
    ],
    "ru": [
        ...
        "/word — словарь: объясни трудное слово 📖",
        "/pronounce — как произносить трудное слово 🗣",
        ...
        "/joke — шутка и интересный факт 😄 (/stopjoke — выключить)",
        ...
        "/review — темы, которые пора повторить 🧠",
        "/summary — краткое резюме этой сессии 📌",
        "/askclass — вопрос классу (в группе, для учителя) 👥",
        "/answers — показать ответы класса (учитель) 📥",
        "/leaderboard — таблица лидеров 🏆",
        "/duel — дуэль с другом 🤝 (/join — присоединиться)",
        ...
        "🎨 пришли рисунок по теме — я порадуюсь 🙂",
    ],
    "en": [
        ...
        "/word — dictionary: explain a hard word 📖",
        "/pronounce — how to pronounce a hard word 🗣",
        ...
        "/joke — a joke and a fun fact 😄 (/stopjoke to turn off)",
        "/challenge — challenge of the day (/challenge 09:00 daily)",
        "/ask — ask me anything 🤔",
        "/favorites — favorite topics ⭐",
        "/weakspots — weak spots 🎯",
        "/review — topics due for review 🧠",
        "/summary — a short recap of this session 📌",
        "/askclass — post a question to the class (group, teacher) 👥",
        "/answers — show the class's answers (teacher) 📥",
        "/leaderboard — the leaderboard 🏆",
        "/duel — duel a friend 🤝 (/join to join)",
        ...
        "🎨 send a drawing of your topic — I'll love it 🙂",
    ],
}
